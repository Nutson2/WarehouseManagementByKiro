...
/// <summary>
/// Интерфейс репозитория для работы с документами отгрузки
/// </summary>
public interface IShipmentDocumentRepository : IRepository<ShipmentDocument>
{
    /// <summary>
    /// Проверить существование документа отгрузки с указанным номером
    /// </summary>
    ...
    /// <summary>
    /// Получить документ отгрузки с ресурсами и клиентом
    /// </summary>
    /// <param name="id">Идентификатор документа</param>
    /// <param name="cancellationToken">Токен отмены</param>
    /// <returns>Документ отгрузки с ресурсами и клиентом или null</returns>
    Task<ShipmentDocument?> GetWithResourcesAndClientAsync(int id, CancellationToken cancellationToken = default);

    /// <summary>
    /// Получить отфильтрованные документы отгрузки
    /// </summary>
    ...
    /// <param name="cancellationToken">Токен отмены</param>
    /// <returns>Коллекция отфильтрованных документов отгрузки</returns>
    Task<IEnumerable<ShipmentDocument>> GetFilteredAsync(
